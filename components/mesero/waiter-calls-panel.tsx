...
export function WaiterCallsPanel() {
  ...
  const getCallColor = (tipo: string) => {
    switch (tipo) {
      case 'cuenta': return 'bg-amber-500'
      case 'atencion': return 'bg-primary'
          ...
          return (
            <Card 
              ...
              className={`border-l-4 ${
                call.tipo === 'cuenta' ? 'border-l-amber-500 bg-amber-50' :
                call.tipo === 'atencion' ? 'border-l-primary bg-primary/5' :
