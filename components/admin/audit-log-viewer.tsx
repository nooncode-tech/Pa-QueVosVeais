        ...
        <ScrollArea className="h-[calc(100vh-240px)]">
          <div className="space-y-1.5">
            {filtered.map(log => {
              ...
              return (
                <div key={log.id} className="flex flex-col sm:flex-row sm:items-center gap-2 p-3 rounded-lg bg-card border border-border hover:bg-secondary/30 transition-colors">
